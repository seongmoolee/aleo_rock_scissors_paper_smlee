...
import "./App.css";
import rock_paper_scissors_smlee from "../rock_paper_scissors_smlee/build/main.aleo?raw";
...
function App() {
  ...
  async function deploy() {
    setDeploying(true);
    try {
      const result = await aleoWorker.deployProgram(rock_paper_scissors_smlee);
        ...
        <p>
          <button disabled={deploying} onClick={deploy}>
            {deploying
              ...
              : `Deploy rock_paper_scissors_smlee.aleo`}
          </button>
        </p>
      </div>
    </>
